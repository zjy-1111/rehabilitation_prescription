...
const (
	...
	ERROR_COUNT_EXAMINATION_FAIL
	ERROR_GET_EXAMINATIONS_FAIL
	ERROR_ADD_EXAMINATION_FAIL
	ERROR_CHECK_EXIST_EXAMINATION_FAIL
	ERROR_NOT_EXIST_EXAMINATION
	ERROR_EDIT_EXAMINATION_FAIL
	ERROR_DELETE_EXAMINATION_FAIL
